...
var Drawio = function (_a) {
    ...
    if (!window.elCache[title] || !window.elCache[title].current) {
        ...
        React.useEffect(function () {
            ...
            el_1.current.dataset.mxgraph = json;
            setTimeout(function () {
                GraphViewer_1.createViewerForElement(el_1.current);
            }, 0);
        }, []);
        window.elCache[title] = el_1;
    }
    return (React__default["default"].createElement("div", { className: "docusaurus-plugin-drawio" },
        React__default["default"].createElement("div", { className: "docusaurus-plugin-drawio__content", ref: window.elCache[title] })));
};
